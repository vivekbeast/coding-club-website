    ...
    <div>
      <div className="justify-center h-screen w-screen flex items-center text-center">
        <div className="flex flex-col items-left text-left">
          ...
          <h1 className=' md:text-lg text-md font-semibold'>Developer: Attendance will be recorded based on your login information, so there's no need to come here!</h1>
