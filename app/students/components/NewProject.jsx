...
function NewProject() {
  ...
  return (
    <section id='CREATEPRO' className='w-[100%] justify-center items-center flex p-6 h-screen'>
      <div className="md:w-[450px] bg-slate-300 w-[300px] shadow-xl flex h-fit flex-col justify-center border-2 rounded-lg  p-6 transform transition-transform duration-300 hover:scale-105">
        <div className="mb-6">
